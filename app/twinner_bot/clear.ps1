...
$PathPairs = @(
    @("..\..\..\common\app\twinner_bot\core\graph.py", ".\core\graph.py"),
    @("..\..\..\common\app\twinner_bot\core\node_common.py", ".\core\node_common.py"),
    @("..\..\..\common\app\twinner_bot\core\node_doc_review.py", ".\core\node_doc_review.py"),
    @("..\..\..\common\app\twinner_bot\core\node_rag.py", ".\core\node_rag.py"),
    @("..\..\..\common\app\twinner_bot\core\node_slide_outline.py", ".\core\node_slide_outline.py"),
    @("..\..\..\common\app\twinner_bot\core\ui.py", ".\core\ui.py"),
    @("..\..\..\common\app\twinner_bot\core\util.py", ".\core\util.py"),
